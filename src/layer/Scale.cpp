...
namespace tmnet
{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Scale::loadParam(FILE* fileFp, int output_num)
	{
		int id = 0;
		int value = 0;
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Scale::calculateFeaSize(std::vector<unsigned int> iIw, std::vector<unsigned int> iIh, std::vector<unsigned int> iIc)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	unsigned long long Scale::fillDDRAddress(unsigned long long uiLastAddr,const char* num)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Scale::getInputScale(FILE *fileFp)
	{
		return 0;
	}
	...
	**************************************************************************/
	void Scale::setQuantize(int iQuantize,float fIScale)
	{
	...
	* Returns       : NULL
	**************************************************************************/
	void Scale::setFp32(int iFp32,unsigned long long uiBiasAddr,unsigned long long uiWScaleAddr,float fIScale)
	{
	...
	**************************************************************************/
	unsigned long long Scale::getNextInputOutputAddr(unsigned long long uiAddr,unsigned int uiOneSeg,\
	...
	* Returns       : uiNewAddr -- next layer input address
	**************************************************************************/
	unsigned long long Scale::setRegisterValue(unsigned long long uiLastAddr,unsigned int uiOneSeg,\
	...
	* Returns       : success
	**************************************************************************/
	int Scale::setRegisterValue(std::vector<unsigned long long> uiInputAddr, std::vector<unsigned long long> uiOutputAddr,const char* num)
	{
		return 0;
	}
	...
	* Returns       : void
	**************************************************************************/
	void Scale::writeDDRInfoInputOutput(FILE *fileOutFp)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Scale::writeBinFile(FILE *fileInFp,FILE *fileOutFp,int iLayerIndex,const char* num)
	{
		return 0;
	}
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Scale::writeddrBinFile(FILE *fileRp)
	{
		return 0;
	}
}
