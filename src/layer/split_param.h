...
#ifndef LAYER_SPLIT_PARAM_H_
#define LAYER_SPLIT_PARAM_H_
...
namespace tmnet
{
    ...
    typedef struct 
	{
        ...
        unsigned int  FeaDstAddr2;	//R/W
		unsigned int  zero2[3] ={0};
    ...
    public:
		...
		//cdp
		unsigned int cdpMode;
		unsigned int heightSeg;
		unsigned int channelPadding;
		unsigned int featureChannel;
		unsigned int featureSegNum;
		unsigned int featureHeightSeg0;
		unsigned int featureHeightSeg1;

		//softmax
		unsigned int classesNums;
		unsigned int classesLength;
    };
}
