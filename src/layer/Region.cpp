...
namespace tmnet
{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Region::loadParam(FILE* fileFp, int output_num)
	{
		int id = 0;
		int value = 0;
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Region::calculateFeaSize(std::vector<unsigned int> iIw, std::vector<unsigned int> iIh, std::vector<unsigned int> iIc)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	unsigned long long Region::fillDDRAddress(unsigned long long uiLastAddr, const char* num)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Region::getInputScale(FILE *fileFp)
	{
		return 0;
	}
	...
	**************************************************************************/
	void Region::setQuantize(int iQuantize,float fIScale)
	{
	...
	* Returns       : NULL
	**************************************************************************/
	void Region::setFp32(int iFp32,unsigned long long uiBiasAddr,unsigned long long uiWScaleAddr,float fIScale)
	{
	...
	**************************************************************************/
	unsigned long long Region::getNextInputOutputAddr(unsigned long long uiAddr,unsigned int uiOneSeg,\
	...
	* Returns       : uiNewAddr -- next layer input address
	**************************************************************************/
	unsigned long long Region::setRegisterValue(unsigned long long uiLastAddr,unsigned int uiOneSeg,\
	...
	* Returns       : success
	**************************************************************************/
	int Region::setRegisterValue(std::vector<unsigned long long> uiInputAddr, std::vector<unsigned long long> uiOutputAddr,const char* num)
	{
		return 0;
	}
	...
	* Returns       : void
	**************************************************************************/
	void Region::writeDDRInfoInputOutput(FILE *fileOutFp)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Region::writeBinFile(FILE *fileInFp,FILE *fileOutFp,int iLayerIndex,const char* num)
	{
		return 0;
	}
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int Region::writeddrBinFile(FILE *fileRp)
	{
		return 0;
	}
}
