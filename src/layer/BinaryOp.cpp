...
namespace tmnet
{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int BinaryOp::loadParam(FILE* fileFp, int output_num)
	{
		int id = 0;
		int value = 0;
		float fvalue = 0;
		zero = output_num;
		if (fscanf(fileFp, "%d=%d", &id,&value) == 2)
		{
			one = value;
		}
		if (fscanf(fileFp, "%d=%f", &id, &fvalue) == 2)
		{
			two = fvalue;
		}
		return 0;
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int BinaryOp::calculateFeaSize(std::vector<unsigned int> iIw, std::vector<unsigned int> iIh, std::vector<unsigned int> iIc)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	unsigned long long BinaryOp::fillDDRAddress(unsigned long long uiLastAddr,const char* num)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int BinaryOp::getInputScale(FILE *fileFp)
	{
		return 0;
	}
	...
	**************************************************************************/
	void BinaryOp::setQuantize(int iQuantize,float fIScale)
	{
	...
	* Returns       : NULL
	**************************************************************************/
	void BinaryOp::setFp32(int iFp32,unsigned long long uiBiasAddr,unsigned long long uiWScaleAddr,float fIScale)
	{
	...
	**************************************************************************/
	unsigned long long BinaryOp::getNextInputOutputAddr(unsigned long long uiAddr,unsigned int uiOneSeg,\
	...
	* Returns       : uiNewAddr -- next layer input address
	**************************************************************************/
	unsigned long long BinaryOp::setRegisterValue(unsigned long long uiLastAddr,unsigned int uiOneSeg,\
	...
	* Returns       : success
	**************************************************************************/
	int BinaryOp::setRegisterValue(std::vector<unsigned long long> uiInputAddr, std::vector<unsigned long long> uiOutputAddr,const char* num)
	{
		return 0;
	}
	...
	* Returns       : void
	**************************************************************************/
	void BinaryOp::writeDDRInfoInputOutput(FILE *fileOutFp)
	{
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int BinaryOp::writeBinFile(FILE *fileInFp,FILE *fileOutFp,int iLayerIndex,const char* num)
	{
		return 0;
	}
	...
	* Returns       : 0 -- success
	**************************************************************************/
	int BinaryOp::writeddrBinFile(FILE *fileRp)
	{
		return 0;
	}
}
